...
exports.run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var model, text, textSplitter, docs, vectorStore, chain, question, res, chatHistory, followUpRes;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                text = fs.readFileSync(path_1["default"].resolve("./src/llms/state_of_the_union.txt"), "utf8");
            ...
            case 1:
                docs = _a.sent();
                return [4 /*yield*/, hnswlib_1.HNSWLib.fromDocuments(docs, new openai_2.OpenAIEmbeddings({ openAIApiKey: "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" }))];
            case 2:
                vectorStore = _a.sent();
                chain = chains_1.ConversationalRetrievalQAChain.fromLLM(model, vectorStore.asRetriever());
                question = "What did the president say about Justice Breyer?";
                return [4 /*yield*/, chain.call({ question: question, chat_history: [] })];
            case 3:
                res = _a.sent();
                console.log(res);
