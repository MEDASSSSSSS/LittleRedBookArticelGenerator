...
exports.run = function () { return __awaiter(void 0, void 0, void 0, function () {
    var data, yamlFile, toolkit, model, executor, input, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                try {
                    yamlFile = fs.readFileSync(path_1["default"].resolve("./package.json"), "utf8");
                ...
                toolkit = new agents_1.JsonToolkit(new tools_1.JsonSpec(data));
                ...
                executor = agents_1.createJsonAgent(model, toolkit);
                input = "What are the required dependencies in the json";
